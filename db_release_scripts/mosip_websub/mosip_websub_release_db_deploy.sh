### -- ---------------------------------------------------------------------------------------------------------
### -- Script Name		: Websub Release DB deploy
### -- Deploy Module 	: MOSIP Websub
### -- Purpose    		: To deploy Websub Database alter scripts for the release.       
### -- Create By   		: Ram Bhatt
...
#========================================DB Alter Scripts deployment process begins on WEBSUB DB SERVER==================================
