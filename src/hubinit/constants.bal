...
const string MESSAGE_COUNT_PARSE_ERROR_MESSAGE= "message count can not be parsed as a integer";
const string PAGE_INDEX_PARSE_ERROR_MESSAGE= "page index can not be parsed as a integer";
