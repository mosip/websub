...
const string RESTART_REPUBLISH_MESSAGES = "SELECT message,topic FROM websub.message_store WHERE id NOT IN (SELECT  msg_id FROM websub.message_delivery_failed UNION SELECT  msg_id FROM websub.message_delivery_success)";
