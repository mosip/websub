...
const string SELECT_FROM_SUBSCRIPTIONS_BY_TOPIC_CALLBACK_TIMESTAMP = "SELECT id,topic, callback, secret, lease_seconds, created_at FROM websub.subscription where topic=? AND callback=? AND (del_dtimes>? or del_dtimes IS NULL) ORDER BY cr_by ASC";
